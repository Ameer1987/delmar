function initialize() {
    ...
    // Multiple Markers
    var markers = [];
    $('.branch_location').each(function (index) {
        markers[index] = $.parseJSON($(this).val());
    })

    // Info Window Content
    var infoWindowContent = [];
    $('.branch_info').each(function (index) {
        infoWindowContent[index] = $.parseJSON($(this).val());
    })

    // Multiple Pointers with Different Colors
    var mapPointers = [];
    $('.branch_marker').each(function (index) {
        mapPointers[index] = $.parseJSON($(this).val());
    })
