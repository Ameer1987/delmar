            ...
            <div class="col-sm-6 col-md-4">
                <div class="widget dark">
                    ...
                    <ul class="list-inline mt-5">
                        <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored mr-5"></i>(19955) hotline 24 hours </li>
                        <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored mr-5"></i>INFO@delmar-attalla.com </li>
